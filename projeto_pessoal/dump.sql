...
# CRIAR TABELA DE REAJUSTE PARA UM PRODUTO:
CREATE TABLE IF NOT EXISTS correcao_produto (
    id INT AUTO_INCREMENT PRIMARY KEY,
    descricao VARCHAR(80) NOT NULL,
    percentual DECIMAL(4,2) NOT NULL DEFAULT 1,
...
# POPULAR A TABELA DE REAJUSTE COM ALGUNS PRODUTOS USANDO A PROCEDURE:

CALL REAJUSTE_PRODUTO('2', '0.9', 'Fecha mês', '2024-03-22', '2024-03-30');
CALL REAJUSTE_PRODUTO('4', '1.02', 'Impostos', CURDATE(), NULL);
CALL REAJUSTE_PRODUTO('10', '0.86', 'Blcak friday', '2024-02-16', '2024-03-09');
